						...
						<div class="col-sm-12">
							<div class="col-sm-8">
								...
								if (!(isset($_SESSION['nu']))) {
									...
									$cerereSQL = 'SELECT a.id, a.titlu, a.descriere, a.data, a.imagine, u.nume, c.titlu FROM anunturi a INNER JOIN referinte r ON a.id = r.id_anunt AND r.id_utilizator='.$_SESSION['nu'].' INNER JOIN utilizator u ON r.id_utilizator = u.id INNER JOIN categorie c on c.id_categorie = r.id_categorie';
										...
										while($rand = mysql_fetch_array($rezultat)) {
											...
											<div class="col-sm-12 margin-bottom-10 secondary-bg no-padding">
												<div class="col-sm-12 padding-10">
													...
													<div class="col-sm-12">Categorii: <?php echo $rand[2] ?></div>
							...
							<div class="col-sm-4 text-right">
								<a href="all-news.php">Toate produsele</div>
							</div>
						</div>
					</div>
				</div>
