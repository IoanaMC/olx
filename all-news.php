                    ...
                    <div class="col-xs-12">
						...
						<div id="news-list" class="col-xs-12">
							...
							//} else {
								...
								$cerereSQL = 'SELECT id_anunt, titlu_anunt, descriere_anunt, data_anunt, imagine_anunt, nume_util, titlu_categorie, nume_oras, nume_judet FROM anunturi INNER JOIN referinte ON id_anunt = id_anunt_ref INNER JOIN utilizatori ON id_utilizator_ref = id_util INNER JOIN categorii on id_categorie = id_categorie_ref INNER JOIN orase ON id_oras = id_oras_anunt INNER JOIN judete ON id_judet = id_judet_anunt';
